#!/usr/bin/env nbb
;; Generate `src/kotoba/industry/embedded.cljc` from
;; `resources/kotoba/industry/registry.edn`.
;;
...
;; depended on by `cloud-itonami-isic-*`, so it would have inherited exactly
;; that fault.
;;
...
(def edn-path "resources/kotoba/industry/registry.edn")
(def out-path "src/kotoba/industry/embedded.cljc")
