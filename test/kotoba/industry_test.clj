...
(deftest maturity-tier
  ...
  (testing "maturity-summary counts tiers"
    (let [m (industry/maturity-summary)]
      ...
      ;; assumed (this promotion's own +1 plus any concurrent sibling
      ;; promotions landed between this file's own last recorded
      ;; number and this edit's fresh clone are folded into the
      ;; live-recomputed baseline here, not individually re-narrated).
      (is (= 314 (:implemented m))))))
