...
(deftest maturity-tier
  ...
  (testing "maturity-summary counts tiers"
    (let [m (industry/maturity-summary)]
      ...
      ;; 285 -> 287: cloud-itonami-isic-2732 (wire/cable/harness,
      ;; ADR-2607160800) plus one further concurrent fleet promotion
      ;; landed in the same window. Live-recomputed via
      ;; `(industry/maturity-summary)` on the just-pushed tip, not assumed.
