...
(deftest maturity-tier
  ...
  (testing "maturity-summary counts tiers"
    (let [m (industry/maturity-summary)]
      ...
      ;; 332 -> 334: this promotion's own +1 for cloud-itonami-isic-3900,
      ;; plus +1 further concurrent sibling promotion landed between this
      ;; file's last recorded number and this edit's freshly re-fetched
      ;; registry.edn (baseline re-run measured 333 :implemented before
      ;; this edit's own registry.edn change was applied), folded into
      ;; the live-recomputed baseline via `(industry/maturity-summary)`,
      ;; not assumed, not individually re-narrated here.
