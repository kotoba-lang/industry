...
(deftest maturity-tier
  ...
  (testing "maturity-summary counts tiers"
    (let [m (industry/maturity-summary)]
      ...
      ;; cloud-itonami-isic-7721's own (ADR-2607104900), then 36 with
      ;; cloud-itonami-isic-7729's own (ADR-2607105100). This is not
      ...
      ;; specific live count.
      (is (= 36 (:blueprint m)))
      ;; 111 = 109 + cloud-itonami-isic-2811 (engines/turbines) +
      ;; cloud-itonami-isic-2410 (basic iron and steel), both promoted
      ;; from :spec placeholders to :implemented classic heavy-industry
