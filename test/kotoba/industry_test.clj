...
(deftest maturity-tier
  ...
  (testing "maturity-summary counts tiers"
    (let [m (industry/maturity-summary)]
      ...
      ;; 323 -> 326: two concurrent promotions landed on main between
      ;; this file's own last recorded number (323) and this edit's
      ;; freshly re-fetched registry.edn (folded into the live-
      ;; recomputed baseline, not individually re-narrated here) plus
      ;; this promotion's own +1 for cloud-itonami-isic-0161.
      ;; Live-recomputed via `(industry/maturity-summary)` on a freshly
      ;; re-fetched origin/main tip immediately before this edit, not
      ;; assumed.
      (is (= 326 (:implemented m))))))
