...
- `:implemented` 347 · `:blueprint` 25 · `:spec` 276 (as of the 2026-07-16
  ...
  `kbb --backend sci scripts/gen-industry-docs.cljk --check` rather than trusting this
  ...
  `docs/isic-coverage.md` (generated by `kbb --backend sci scripts/gen-industry-docs.cljk`)
